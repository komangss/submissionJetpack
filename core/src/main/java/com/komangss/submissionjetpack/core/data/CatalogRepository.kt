...
@Inject constructor(
    ...
    override fun getFavoriteMovies(): LiveData<PagedList<Movie>> {
        val dataSourceMovie: DataSource.Factory<Int, Movie> =
            catalogLocalDataSource.getFavoriteMovies().map { catalogMovieMapper.entityToDomain(it) }
    ...
    override fun getFavoriteTvShows(): LiveData<PagedList<TvShow>> {
        val dataSourceTvShow: DataSource.Factory<Int, TvShow> =
